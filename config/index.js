export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd37de48caf408b72",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "fe39b21ad3408b2090f6f1ad1610698f",
  ...
  USERS: [
    {
      ...
      id: "ojned546G6vrDNUKv6wi6vfuDsYQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "-ZEc-FgnTz97Kd_HzPNJInPdOYxT7TsokjDcUz1qzjQ",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
  ...
  CALLBACK_TEMPLATE_ID: "-ZEc-FgnTz97Kd_HzPNJInPdOYxT7TsokjDcUz1qzjQ",
